...
ComponentRegistry.register({
  ...
  colorTokens: [
    ...
    { token: 'Image BG', variable: '--bg-surface-brand', value: '#EDE8FE', description: 'Image area background (primary-100)' },
    { token: 'Title', variable: '--fg-primary', value: '#091141', description: 'Title text color (neutral-900)' },
