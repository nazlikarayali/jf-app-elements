...
ComponentRegistry.register({
  ...
  colorTokens: [
    { token: 'Background', variable: '--bg-surface', value: '#FFFFFF', description: 'Container background' },
    { token: 'Title', variable: '--fg-primary', value: '#091141', description: 'Heading text (neutral-900)' },
    { token: 'Description', variable: '--fg-disabled', value: '#979DC6', description: 'Subheading text (neutral-300)' },
    { token: 'Goal Labels', variable: '--fg-primary', value: '#091141', description: 'Raised/Goal text (neutral-900)' },
    { token: 'Progress Track', variable: '--bg-page', value: '#F3F3FE', description: 'Progress bar track (neutral-50)' },
    { token: 'Progress Fill', variable: '--bg-fill-brand', value: '#7D38EF', description: 'Progress bar fill (primary-600)' },
    { token: 'Amount Border', variable: '--border-active', value: '#C8CEED', description: 'Amount item border (neutral-200)' },
