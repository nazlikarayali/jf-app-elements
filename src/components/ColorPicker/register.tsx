...
ComponentRegistry.register({
  ...
  colorTokens: [
    { token: 'Background', variable: '--bg-fill', value: '#FFFFFF', description: 'Picker background' },
    { token: 'Border', variable: '--border', value: '#DADEF3', description: 'Picker border (neutral-100)' },
    { token: 'Saturation Area', variable: '--radius-md', value: '8px', description: 'Saturation area radius' },
    { token: 'Slider Border', variable: '--radius-rounded', value: '9999px', description: 'Slider border radius' },
    { token: 'Eyedropper Border', variable: '--border-secondary', value: '#C8CEED', description: 'Eyedropper border (neutral-200)' },
    { token: 'Input BG', variable: '--bg-fill', value: '#FFFFFF', description: 'Hex input background' },
    { token: 'Input Border', variable: '--border', value: '#DADEF3', description: 'Hex input border (neutral-100)' },
    { token: 'Hex Text', variable: '--fg-secondary', value: '#353C6A', description: 'Hex text color (neutral-600)' },
  ],
