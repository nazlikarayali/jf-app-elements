...
ComponentRegistry.register({
  ...
  colorTokens: [
    { token: 'Background', variable: '--bg-surface', value: '#FFFFFF', description: 'List background' },
    { token: 'Image BG', variable: '--bg-surface-brand', value: '#EDE8FE', description: 'Image placeholder (primary-100)' },
    { token: 'Title', variable: '--fg-primary', value: '#091141', description: 'Item title (neutral-900)' },
    { token: 'Description', variable: '--fg-disabled', value: '#979DC6', description: 'Item description (neutral-300)' },
